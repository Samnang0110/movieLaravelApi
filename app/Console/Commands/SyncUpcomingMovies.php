...
class SyncUpcomingMovies extends Command
{
    protected $signature = 'sync:upcoming';
    protected $description = 'Sync upcoming movies from TMDB into the local database';
    ...
    public function handle()
    {
        ...
        $this->info("📅 Syncing upcoming movies from TMDB...");
        ...
        $this->info("✅ All upcoming movies synced!");
    }
}