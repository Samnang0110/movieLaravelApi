...
class SyncNowPlayingMovies extends Command
{
    protected $signature = 'sync:now-playing';
    protected $description = 'Sync now playing movies from TMDB into the local database';
    ...
    public function handle()
    {
        ...
        $this->info("🎥 Syncing now playing movies from TMDB...");
        ...
        $this->info("✅ All now playing movies synced!");
    }
}